...
class HtmlTagSwitchButton extends HtmlTag
{
  ...
  public function html()
  {
    ...
    <div
      class="wpbones-switch-button wpbones-switch-mode-<?php echo $mode ?> wpbones-switch-button-<?php echo $this->theme ?> <?php echo $disabled ? 'disabled' : '' ?>">
      <input type="hidden" name="<?php echo $this->name ?>" value="0" />
      <?php echo $leftLabel ?>
      <input <?php echo $this->formatDataAttributes() ?>
